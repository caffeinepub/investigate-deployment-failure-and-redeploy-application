...
import { Music, ExternalLink, Flame } from 'lucide-react';
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-foreground">Top Vibing Songs</h2>
          </div>
          ...
          {songs.map((song, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-muted-foreground text-sm truncate mt-0.5">{song.artistName}</p>
                <div className="mt-2">
