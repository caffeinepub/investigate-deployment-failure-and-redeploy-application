...
import { useAdminEditSubmission, useGetAllArtistProfiles } from '../hooks/useQueries';
...
export default function AdminEditSubmissionDialog({
  submission,
  open,
  onOpenChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {/* Language */}
          <div>
            <Label htmlFor="admin-edit-language">Language *</Label>
          ...
          {/* Release Date */}
          <div>
            <Label htmlFor="admin-edit-releaseDate">Release Date *</Label>
            <Input
              id="admin-edit-releaseDate"
              type="date"
              value={releaseDate}
          ...
          {/* Release Type */}
          <div>
            <Label htmlFor="admin-edit-releaseType">Release Type *</Label>
          ...
          {/* Genre */}
          <div>
            <Label htmlFor="admin-edit-genre">Genre *</Label>
          ...
          {/* Producer */}
          <div>
            <Label htmlFor="admin-edit-producer">Producer *</Label>
            <Input
          ...
          {/* Artwork Upload */}
          <div>
            <Label htmlFor="admin-edit-artwork">Artwork (JPG/PNG, 3000×3000 pixels)</Label>
            <Input
              id="admin-edit-artwork"
              type="file"
              accept=".jpg,.jpeg,.png"
          ...
          {!isAlbum && (
            <div>
              <Label htmlFor="admin-edit-audio">Audio File</Label>
              <Input
                id="admin-edit-audio"
                type="file"
                accept="audio/*"
          ...
          {/* Music Video Link */}
          <div>
            <Label htmlFor="admin-edit-musicVideoLink">Music Video Link (Optional)</Label>
            <Input
              id="admin-edit-musicVideoLink"
          ...
          {/* Additional Details */}
          <div>
            <Label htmlFor="admin-edit-additionalDetails">Additional Details (Optional)</Label>
            <Textarea
              id="admin-edit-additionalDetails"
          ...
          {/* Discount Code */}
          <div>
            <Label htmlFor="admin-edit-discountCode">Discount Code (Optional)</Label>
            <Input
              id="admin-edit-discountCode"
              value={discountCode}
